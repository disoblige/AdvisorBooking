<%@ Page Title="" Language="C#" MasterPageFile="~/AdvisorBookingServiceMasterPage.master" AutoEventWireup="true" CodeFile="StudentProfileUpdate.aspx.cs" Inherits="StudentProfileUpdate" %>
                        ...
                        <tr>
                            ...
                            <td valign="middle" colspan="2">
                                <asp:DropDownList ID="ddlProgramName" runat="server" 
                                    DataSourceID="StudentSqlDataSource" DataTextField="Program_Name" 
                                ...
                                <asp:SqlDataSource ID="StudentSqlDataSource" runat="server" 
                                    ...
                                    SelectCommand="SELECT [Program_Id], [Program_Name] FROM [Program]">
                                </asp:SqlDataSource>
                            </td>
                        </tr>
                        <tr>
