...
public class DatabaseRegistration
{
    ...
    public void insert_Student_Info(String studentID, String firstName, String lastName, String program, String currSem, String photoURL)
    {
        ...
        str = "insert into Student Values(@p1,@p2,@p3,@p4,@p5,@p6);";
    ...
    public void update_Student_Info(String studentID, String firstName, String lastName, String program, String currSem, String photoURL)
    {
        ...
        cmd.Connection = con;
        cmd.CommandType = CommandType.Text;
        str = "update Student Set First_Name=@p1, Last_Name=@p2,Program_Id=@p3, Cur_Sem=@p4,Image=@p5 where Student_ID=@p6";
        ...
        cmd.Parameters.AddWithValue("@p5", "photo");
    ...
    public void update_Password(String studentID, String oldPassword, String newPassword)
    {
        con.Open();
        cmd.Connection = con;
        cmd.CommandType = CommandType.Text;
