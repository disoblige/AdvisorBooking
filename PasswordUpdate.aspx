<%@ Page Title="" Language="C#" MasterPageFile="~/AdvisorBookingServiceMasterPage.master" AutoEventWireup="true" CodeFile="PasswordUpdate.aspx.cs" Inherits="PasswordUpdate" %>
...
<form id="form1" runat="server">
          ...
          <div class="post" id="post-5">
            <div class="post-title">
              <center><h2><a href="#">Update Password</a></h2></center>
            </div>
              ...
              <div class="post-entry-top">
                <div class="post-entry-bottom">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="width: 137px; text-align: right" valign="middle">
                                <asp:Label ID="lblOldPassword" runat="server" style="font-weight: 700" 
                            ...
                            <td style="width: 221px" valign="middle">
                                ...
                                <asp:RequiredFieldValidator ID="rfvOldPassword" runat="server" 
                                    ErrorMessage="Password should not be blank" ControlToValidate="txtOldPassword" 
                        ...
                        <tr>
                            ...
                            <td style="width: 221px" valign="middle">
                                <asp:Button ID="btnUpdatePassword" runat="server" Text="Update Password" 
                                    Width="219px" onclick="btnUpdate_Click"  />
                            </td>
                            <td valign="middle">
                                &nbsp;</td>
                        </tr>
