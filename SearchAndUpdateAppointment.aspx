<%@ Page Title="" Language="C#" MasterPageFile="~/AdvisorBookingServiceMasterPage.master" AutoEventWireup="true" CodeFile="SearchAndUpdateAppointment.aspx.cs" Inherits="CancelAppointment" %>
    ...
    <form id="form1" runat="server">
          ...
          <div class="post" id="post-5">
            <div class="post-title">
              <center><h2>Search for Appoinment to Update</h2></center>
            </div>
